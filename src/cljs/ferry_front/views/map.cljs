...
#_(def tvar-waypoints "{\"type\":\"GeometryCollection\", \"geometries\": [\n{\"type\":\"Point\",\"coordinates\":[20.5106347,60.1115177,0]},\n{\"type\":\"Point\",\"coordinates\":[20.6823206,60.1100751,0]},\n{\"type\":\"Point\",\"coordinates\":[20.726748,60.2191638,0]},\n{\"type\":\"Point\",\"coordinates\":[20.2965061,60.1176075,0]},\n{\"type\":\"Point\",\"coordinates\":[20.5106347,60.1115177,0]},\n{\"type\":\"Point\",\"coordinates\":[20.726748,60.2191638,0]}\n]}")
...
; json-transparent throws an uncaught error
; core.cljs:316 Uncaught Error: No protocol method IWatchable.-add-watch defined for type cljs.core/PersistentVector:
...
(defn choose-highlight-json [arrival-stop departure-stop line-segments]
  ...
  (doseq [line line-segments]
    (do
      (when (and (= (js/parseInt departure-stop) (js/parseInt(:from_stop line)))
                 (= (js/parseInt arrival-stop) (js/parseInt(:to_stop line))))
        (re-frame/dispatch [::events-timetables/change-highlight-segment (jsons-route-highlight (:geometry line))] ) ))))

(def view-position (atom [60.10
                          21.00]))
